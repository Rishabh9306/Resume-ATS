 ...
 * Verify a subscription payment signature and activate the plan immediately.
 */
export async function POST(request) {
  try {
    ...
    if (!isMock) {
      ...
      // For subscriptions, the signature format is: payment_id + '|' + subscription_id
    ...
    console.log(`Successfully verified subscription & activated plan: user=${userId}, plan=${planId}`);
