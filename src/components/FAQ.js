...
const faqData = [
  ...
  { q: 'Can I use it for free?', a: 'Yes! Our free tier gives you 5 scans per month plus 3 AI rewrite suggestions — no credit card required. Upgrade to Pro (just ₹149/mo) for unlimited scans, unlimited AI rewrites, all breakdown categories, and PDF report exports.' },
